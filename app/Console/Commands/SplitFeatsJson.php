...
class SplitFeatsJson extends Command
{
  protected $signature = 'open5e:split-feats 
                            {--path=storage/data/open5e/srd-2014/Feat.json}
                            {--output=storage/data/srd-2014/feats}';

  protected $description = 'Splits Open5e Feat.json into individual files';
