...
class SplitRuleSetsJson extends Command
{
  protected $signature = 'open5e:split-rulesets 
                            {--path=storage/data/open5e/srd-2014/RuleSet.json : Path to the original RuleSet.json} 
                            {--output=storage/data/srd-2014/rulesets : Output directory for split files}';

  protected $description = 'Splits Open5e RuleSet.json into individual files';
