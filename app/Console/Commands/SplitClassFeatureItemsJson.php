...
class SplitClassFeatureItemsJson extends Command
{
  protected $signature = 'open5e:split-class-feature-items 
                            {--path=storage/data/open5e/srd-2014/ClassFeatureItem.json}
                            {--output=storage/data/srd-2014/class-feature-items}';

  protected $description = 'Splits Open5e ClassFeatureItem.json into individual files';
