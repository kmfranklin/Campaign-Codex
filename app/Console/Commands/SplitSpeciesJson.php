...
class SplitSpeciesJson extends Command
{
  protected $signature = 'open5e:split-species 
                          {--path=storage/data/open5e/srd-2014/Species.json} 
                          {--output=storage/data/srd-2014/species}';

  protected $description = 'Splits Species.json into individual files';
