...
class SplitSizesJson extends Command
{
  protected $signature = 'open5e:split-sizes
                            {--path=storage/data/open5e/srd-2014/Size.json : Path to original Size.json}
                            {--output=storage/data/srd-2014/sizes : Output directory for split files}';

  protected $description = 'Splits Open5e Size.json into individual files';
