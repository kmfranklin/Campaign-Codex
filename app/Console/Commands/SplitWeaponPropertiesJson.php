...
class SplitWeaponPropertiesJson extends Command
{
  protected $signature = 'open5e:split-weapon-properties 
                          {--path=storage/data/open5e/srd-2014/WeaponProperty.json}
                          {--output=storage/data/srd-2014/weapon_properties}';

  protected $description = 'Splits WeaponProperty.json into individual files';
