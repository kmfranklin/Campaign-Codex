...
class SplitWeaponsJson extends Command
{
  protected $signature = 'open5e:split-weapons 
                          {--path=storage/data/open5e/srd-2014/Weapon.json}
                          {--output=storage/data/srd-2014/weapons}';

  protected $description = 'Splits Weapon.json into individual files';
