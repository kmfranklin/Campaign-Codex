...
class SplitSpeciesTraitsJson extends Command
{
  protected $signature = 'open5e:split-species-traits 
                          {--path=storage/data/open5e/srd-2014/SpeciesTrait.json}
                          {--output=storage/data/srd-2014/species_traits}';

  protected $description = 'Splits SpeciesTrait.json into individual files';
