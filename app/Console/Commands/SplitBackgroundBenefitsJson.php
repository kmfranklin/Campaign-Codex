...
class SplitBackgroundBenefitsJson extends Command
{
  protected $signature = 'open5e:split-background-benefits 
                          {--path=storage/data/open5e/srd-2014/BackgroundBenefit.json}
                          {--output=storage/data/srd-2014/background_benefits}';

  protected $description = 'Splits BackgroundBenefit.json into individual files';
