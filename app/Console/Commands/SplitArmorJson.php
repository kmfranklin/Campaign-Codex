...
class SplitArmorJson extends Command
{
  protected $signature = 'open5e:split-armor 
                          {--path=storage/data/open5e/srd-2014/Armor.json}
                          {--output=storage/data/srd-2014/armor}';

  protected $description = 'Splits Armor.json into individual files';
